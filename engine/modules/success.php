...
['from' => ['{message}', '{total_case}', '{total_users}', '{online_people}'], 'to' => ['<div class="alert bg-success" role="alert" style="margin-top: 10px;"><span class="glyphicon glyphicon-exclamation-sign"><center><b></span><body><p style="font-size:22px">Вы успешно пополнили баланс</body></div></b></center>', $totalcase, $totaluser, sizeof(file($base))]]);
